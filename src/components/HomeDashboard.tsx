    ...
    <div className="w-full h-full bg-background overflow-hidden flex items-center justify-center p-8">
      <div className="max-w-2xl text-center">
        ...
        <div className="mt-12 pt-8 border-t border-border/30">
          <p className="font-body text-xs text-sand/50 tracking-[0.15em] uppercase mb-6">
            Acceso rápido
          </p>
          <div className="flex gap-4 justify-center">
            <a
              ...
              className="group relative px-8 py-4 bg-bioluminescent/10 border border-bioluminescent/30 hover:bg-bioluminescent/20 transition-all duration-300 overflow-hidden"
            >
              ...
              <div className="relative flex items-center gap-3">
                <svg className="w-5 h-5 text-bioluminescent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" />
                </svg>
                <span className="font-display text-sm text-bioluminescent tracking-[0.15em]">
            ...
            <a
              ...
              className="group relative px-8 py-4 bg-sand/10 border border-sand/30 hover:bg-sand/20 transition-all duration-300 overflow-hidden"
            >
              ...
              <div className="relative flex items-center gap-3">
                ...
                <span className="font-display text-sm text-sand tracking-[0.15em]">
                  MAPA INTERACTIVO
                </span>
              </div>
            </a>
